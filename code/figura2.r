...
tiff("figures/hipoxia.tiff", width = 6, height = 4, units = "in", res = 300)
p_hypoxia
dev.off()
...
tiff("figures/tnfa.tiff", width = 6, height = 4, units = "in", res = 300)
p_tnfa
dev.off()
...
ssgsea_c4 <- run_ssgsea_heatmap_cluster(
  dds = res_c4$dds,
  meta_use = res_c4$meta_use,
  fgsea_obj = fgsea_c4,
  cluster_use = "4"
)

draw(ssgsea_c4$heatmap)
